...
\noindent
This paper presents a proof-of-concept digital twin framework for modeling glucose dynamics using Continuous Glucose Monitoring (CGM) data. The proposed system integrates machine learning, temporal modeling, and causal reasoning to enable simulation-based exploration of intervention scenarios such as dietary changes and physical activity.

Unlike traditional predictive models, the framework focuses on generating interpretable simulated trajectories rather than clinically validated outcomes. A reproducible evaluation is conducted using a public benchmark dataset combined with controlled synthetic scenarios to illustrate temporal behavior and intervention effects.

The results demonstrate the feasibility of integrating prediction with counterfactual simulation for decision-aware analysis. This work does not claim clinical readiness but provides a structured foundation for future research on simulation-driven digital twin systems in healthcare.
